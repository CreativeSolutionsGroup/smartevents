...
*/
-- CreateEnum
CREATE TYPE "public"."Roles" AS ENUM ('VIEWER', 'EDITOR', 'ADMIN');
...
-- CreateTable
CREATE TABLE "public"."AuthorizedUser" (
    "id" TEXT NOT NULL,
    "email" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "AuthorizedUser_email_key" ON "public"."AuthorizedUser"("email");
...
-- AddForeignKey
ALTER TABLE "public"."Attendance" ADD CONSTRAINT "Attendance_userId_fkey" FOREIGN KEY ("userId") REFERENCES "public"."AuthorizedUser"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
